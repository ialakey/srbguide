...
class CreateWhiteCardboardScreen extends StatefulWidget {
  const CreateWhiteCardboardScreen({super.key});

  @override
  State<CreateWhiteCardboardScreen> createState() =>
      _CreateWhiteCardboardScreenState();
}

class _CreateWhiteCardboardScreenState
    extends State<CreateWhiteCardboardScreen> {
  ...
  String _gender = 'M';
  final List<String> _genderOptions = ['M', 'Ž'];
  ...
  Future<void> _saveData() async {
    ...
    await prefs.setString('surname',
        _surnameController.text.isEmpty ? "" : _surnameController.text);
    ...
    await prefs.setString('nationality',
        _nationalityController.text.isEmpty ? "" : _nationalityController.text);
    await prefs.setString(
        'documentNumber',
    ...
    await prefs.setString('ownerInfo',
        _ownerInfoController.text.isEmpty ? "" : _ownerInfoController.text);
    await prefs.setString(
        'placeArrival',
        _placeArrivalController.text.isEmpty
            ? ""
            : _placeArrivalController.text);
    await prefs.setString('dateOfBirth',
        _dateOfBirth != null ? _dateOfBirth!.toIso8601String() : "");
    await prefs.setString('arrivalDate',
        _arrivalDate != null ? _arrivalDate!.toIso8601String() : "");
    await prefs.setString('registrationDate',
        _registrationDate != null ? _registrationDate!.toIso8601String() : "");
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title:
            Text(AppLocalizations.of(context)!.translate('create_whiteboard')),
        actions: [
          ...
          child: ListView(
            children: [
              ...
              TextFormFieldContainer(
                ...
                child: ListTile(
                  title: Text(
                    '${AppLocalizations.of(context)!.translate('date_of_birth')}: ${_dateOfBirth != null ? _dateOfBirth!.toString().split(' ')[0] : AppLocalizations.of(context)!.translate('choose_date')}',
                  ),
                  trailing: ThemedIcon(
              ...
              TextFormFieldContainer2(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListTile(
                      title: Text(
                        '${AppLocalizations.of(context)!.translate('arrival_date')}: ${_arrivalDate != null ? _arrivalDate!.toString().split(' ')[0] : AppLocalizations.of(context)!.translate('choose_date')}',
                      ),
                      trailing: ThemedIcon(
                        iconPath: 'assets/icons_24x24/calendar.png',
                        size: 24.0,
              ...
              TextFormFieldContainer2(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                      labelText: AppLocalizations.of(context)!
                          .translate('registration_address')),
                  maxLines: null,
                  keyboardType: TextInputType.multiline,
                ),
              ),
              ...
              TextFormFieldContainer2(
                labelText:
                    'Податак о станодавцу (презиме и име и ЈМБГ, односно назив правног лица или предузетника и ПИБ)',
                labelText2:
                    'Surname, given name and personal identification number of the landlord/host ie, name of legal entity or entrepreneur and tax ID number).',
                child: TextFormField(
              ...
              TextFormFieldContainer2(
                ...
                child: ListTile(
                  title: Text(
                    '${AppLocalizations.of(context)!.translate('registration_date')}: ${_registrationDate != null ? _registrationDate!.toString().split(' ')[0] : AppLocalizations.of(context)!.translate('choose_date')}',
                  ),
                  trailing: ThemedIcon(
                    iconPath: 'assets/icons_24x24/calendar.png',
                    size: 24.0,
  ...
  void _onButtonPressed(bool isSending) {
    final params = {
      ...
      'name': _nameController.text.isEmpty ? "" : _nameController.text,
      'dateOfBirth':
          _dateOfBirth != null ? _dateOfBirth!.toString().split(' ')[0] : "",
      'sex': _gender,
      ...
      'documentNumber': _documentNumberController.text.isEmpty
          ...
          : _documentNumberController.text,
      'dateOfEntry':
          '${_arrivalDate != null ? _arrivalDate!.toString().split(' ')[0] : ""} ${_placeArrivalController.text.isEmpty ? "" : _placeArrivalController.text}',
      'addressOfPlace':
          _addressController.text.isEmpty ? "" : _addressController.text,
      'landlordInformation':
          _ownerInfoController.text.isEmpty ? "" : _ownerInfoController.text,
      'dateOfRegistration': _registrationDate != null
