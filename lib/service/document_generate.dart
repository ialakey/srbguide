...
class DocumentGenerator {
  static Future<void> generateAndEventDocument(
      Map<String, Object?> params, bool isSend) async {
    final ByteData templateData =
        await rootBundle.load('assets/template/cardboard.docx');
    ...
    final outputFilePath =
        '${directory.path}/Белый картон от $formattedDate.docx';
    ...
    if (isSend) {
      await SharePlus.instance.share(
        ShareParams(
          ...
          text: 'Белый картон от $formattedDate',
        ),
      );
    } else {
